import ClientImg1 from "../assets/images/Testimonial/client1.jpg";
import ClientImg2 from "../assets/images/Testimonial/client2.jpg";
import ClientImg3 from "../assets/images/Testimonial/client3.jpg";
import ClientImg4 from "../assets/images/Testimonial/client4.jpg";
import ClientImg5 from "../assets/images/Testimonial/client5.jpg";
...
const testimonialData = [
  {
    ...
    image: ClientImg1,
    message:
      "My best experience with an online seller and designer was working with John Doe. She was quick to respond, quick to communicate, and created a fantastic design that completely matched our need. We just made minor changes to the original drawings. Overall, it was well worth the extra money to have high-quality work.",
  },
  {
